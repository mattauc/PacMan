...
public class SuperFruit extends Collectibles {
   ...
   * @param sprite PImage
   */
  public SuperFruit(int x, int y, boolean solid, PImage sprite) {
    super(x, y, solid, sprite);
  }

  /**
   * Checks whether the SuperFruit is active
  ...
  /**
   * Checks whether Waka is on SuperFruit
